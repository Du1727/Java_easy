...
//		System.out.println(vlist.size());
		list = new List(vlist.size(), false);  //3개만 다 보이겠다, 단일선택만 가능하게 ! (여러개 선택X)
		...
		if(len > 0)   list.select(0);  //  데이터가 하나라도 있으면 ~ 첫번째를 선택해라  ! 커서를 둬라 ~
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b1 /*수정버튼*/) {
			...
			if(zf == null) 		zf = new ZipcodeFrame(this);
			else 					zf.setVisible(true);
