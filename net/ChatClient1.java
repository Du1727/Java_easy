...
public class ChatClient1 extends JFrame implements ActionListener, Runnable{
	...
	public ChatClient1() {
		...
		//p1.add(tf1 = new JTextField("127.0.0.1",15));  //내pc
		p1.add(tf1 = new JTextField("113.198.238.123",15)); // 강사pc
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == tf1 || obj == btn1) /*connect*/ {
			...
			if(str.length() == 0) return;  //서버로 전송하지 않고, 메서드 빠져 나감
